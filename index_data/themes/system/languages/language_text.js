function loadTexts() {
  ...
  a000.innerHTML = "SP2"; // Storage Player
  ...
  a007.innerHTML = "LOADING..."; // Menu
  var a008 = document.getElementById("lBtnLang");
  a008.innerHTML = "Continue"; // Continue
  var a008 = document.getElementById("ctTextLang");
  a008.innerHTML = "Location of custom theme"; // Location of custom theme
  var a008 = document.getElementById("cTcheck");
  a008.innerHTML = "Check"; // Check
  var a008 = document.getElementById("applySettings");
  a008.innerHTML = "Apply"; // Apply
  /////////////////////////////////Ifs/////////////////////////////////
  var a000_if = document.getElementById("fssl1");
  if(navigator.userAgent.match(/mobile/i)) {
    a000_if.innerHTML = "One press for hide interface"; // One press for hide interface
  }else{
    a000_if.innerHTML = "One click for hide interface"; // One click for hide interface
  }
  var a001_if = document.getElementById("fssl2");
  if(navigator.userAgent.match(/mobile/i)) {
    a001_if.innerHTML = "Doube press for close"; // Doube press for close
  }else{
    a001_if.innerHTML = "Doube click for close"; // Doube click for close
  }
  /////////////////////////////////Sets/////////////////////////////////
