<a href="https://github.com/DragonHtmIL/mnts.sp.org?tab=readme-ov-file#english">English</a>
...
<h4>English</h4><br>
<h1>Storage Player 0.1.6-09012026</h1>
<hr>
...
ArthurVesta make this site by coding a lot from 30 minutes-1~2 hours through <a href="https://code.visualstudio.com">Visual Studio Code</a>.
<hr>
...
This site is with copyfree!<br>
Do not distribute any of scripts!<br>
and this site is free usage;
<h1>Have fun!</h1>

<h4>Русский</h4><br>
<h1>Проигрыватель хранилища 0.1.6-09012026</h1>
<hr>
...
Сайт ArthurVesta был создан благодаря интенсивной работе над кодом, которая заняла от 30 минут до 1~2 часов в <a href="https://code.visualstudio.com">Visual Studio Code</a>.
<hr>
...
<hr>
<img src="https://github.com/user-attachments/assets/9fc9ef63-7696-4ee0-9cb1-be625d87cf9b" style="width: 55px; height: 55px">
Этот сайт не содержит материалов, защищенных авторским правом!<br>
Не распространяйте никакие скрипты!<br>
И этот сайт бесплатен для использования;
<h1>Веселитьсь!</h1>

<div style="direction:rtl;">
<h4>עברית</h4><br>
<h1>נגן אחסון 0.1.6-09012026</h1>
<hr>
...
ArthurVesta יצר את האתר הזה על ידי קידוד רב, החל מ-30 דקות עד שעה-שעתיים, באמצעות <a href="https://code.visualstudio.com">Visual Studio Code</a>.
<hr>
...
<hr>
<img src="https://github.com/user-attachments/assets/9fc9ef63-7696-4ee0-9cb1-be625d87cf9b" style="width: 55px; height: 55px">
אתר זה הוא ללא זכויות יוצרים!<br>
אין להפיץ אף אחד מהסקריפטים!<br>
